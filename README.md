...
[dig_clock.vhd testbench]()
![dig_clock.vhd simulation](images/tb_digital_clock.png)
...
[time_comp_alarm.vhd testbench]()
![time_comp_alarm.vhd simulation](images/tb_alarm.png)
...
[button_debouncer.vhd testbench]()
![button_debouncer.vhd simulation](images/tb_button_debouncer.png)
...
[clock_setter.vhd testbench]()
![clock_setter.vhd simulation](images/tb_clock_setter.png)

### `cnt_up_down.vhd`
Predesigned bidirectional counter from lab exercises.

[cnt_up_down.vhd testbench]()
![cnt_up_down.vhd simulation](images/tb_cnt_up_down.png)

### `hex_7seg.vhd`
Predesigned 7-segment display decoder from lab exercises.

[hex_7seg.vhd testbench]()
![hex_7seg.vhd simulation](images/tb_hex_7seg.png)
...
[driver_7seg_6digits.vhd testbench]()
![driver_7seg_6digits.vhd simulation](images/tb_driver_7seg_6digits.png)
...
[to_bcd_conv.vhd testbench]()
![to_bcd_conv.vhd simulation](images/tb_to_bcd_conv.png)

### `clock_enable.vhd`
Predesigned clock enable signal generator from lab exercises.

[clock_enable.vhd testbench]()
![clock_enable.vhd simulation](images/tb_clock_enable.png)
...
[driver_dig_clock.vhd testbench]()
![driver_dig_clock.vhd simulation](images/tb_driver_dig_clock.png)
